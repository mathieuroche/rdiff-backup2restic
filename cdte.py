...
def change_arbo_encoding(dir, src_encoding = 'ISO-8859-1', dst_encoding = 'utf-8'):
    nb_renamed = 0
    logging.info('Change arborescence encoding or %s (%s=>%s)' % (dir, src_encoding, dst_encoding))
